          ...
          <>
                ...
                <CardContent className="space-y-2">
                    ...
                    <div className="flex items-center justify-between p-3 bg-background rounded-lg border border-destructive/50">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-destructive">
                          Eventos críticos detectados ({dashboardData.events.critical_count})
                        </span>
                      </div>
                      <Button
                        size="sm"
                  ...
                  {dashboardData.alerts.has_suspicious_sessions && (
                    <div className="flex items-center justify-between p-3 bg-background rounded-lg border border-orange-500/20">
                      <div className="flex items-center gap-2">
                        <Monitor className="w-4 h-4 text-orange-600 dark:text-orange-500" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold">{dashboardData.sessions.total_active}</div>
                  <p className="text-xs text-gray-500 mt-1">
                    {dashboardData.sessions.unique_ips} IP{dashboardData.sessions.unique_ips !== 1 ? "s" : ""} única{dashboardData.sessions.unique_ips !== 1 ? "s" : ""}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {dashboardData.sessions.has_suspicious ? "Requiere atención" : "Sin alertas"}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-3xl font-bold">{dashboardData.events.total_last_30_days}</div>
                  <p className="text-xs text-gray-500 mt-1">
                    {dashboardData.events.critical_count} crítico{dashboardData.events.critical_count !== 1 ? "s" : ""}
                  </p>
                </CardContent>
              </Card>
            ...
            {dashboardData.events.recent_critical && dashboardData.events.recent_critical.length > 0 && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Últimos 7 días - Requieren atención inmediata</CardDescription>
                </CardHeader>
                <CardContent>
