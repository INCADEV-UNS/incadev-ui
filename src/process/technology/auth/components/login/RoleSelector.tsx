    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-500/5 via-background to-purple-500/5">
      ...
      <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 pt-8 sm:pt-12 md:pt-20 lg:pt-32 pb-8 sm:pb-12">
        <div className="text-center mb-8 sm:mb-10 md:mb-12 animate-in fade-in slide-in-from-top duration-700">
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 px-4">{TECHNOLOGY_MODULE_META.name}</h1>
            ...
            return (
              ...
              >
                ...
                <CardHeader className="pb-3 sm:pb-4 p-4 sm:p-6 relative z-10">
                  <div className={`w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-br ${role.color} flex items-center justify-center text-white mb-3 sm:mb-4 shadow-lg ring-2 sm:ring-4 ring-background group-hover:scale-110 group-hover:rotate-3 transition-all duration-300`}>
                    <Icon className="h-6 w-6 sm:h-7 sm:w-7 md:h-8 md:w-8" />
                  </div>
                  <CardTitle className="text-lg sm:text-xl transition-colors">
                    {role.name}
                  </CardTitle>
